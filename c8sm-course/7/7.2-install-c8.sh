...
# 7.2.3
helm template camunda-platform camunda/camunda-platform --version "$C8_VERSION" --values "${SCRIPT_PATH}/c8-helm-settings.yaml" --skip-tests | kubectl apply -n "$C8_NAMESPACE" -f -
