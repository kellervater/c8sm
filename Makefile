...
download-test:		## Chapter 8.1 - Downloads unhealthy values file
  ./c8sm-course/8/8.1-download-test-case.sh

reinstall-c8:			## Chapter 8.1 - Reinstall with unhealthy values
